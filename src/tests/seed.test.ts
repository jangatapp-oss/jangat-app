...
describe("seed JÀNGAT V1",()=>{
  ...
  it("contient les quantités pédagogiques attendues",()=>{expect(MODULES).toHaveLength(22);expect(LESSONS).toHaveLength(84);expect(DIAGNOSTIC_QUESTIONS).toHaveLength(15);expect((seed.match(/30000000-0000-4000-8000-/g)||[]).length).toBeGreaterThanOrEqual(22)});
